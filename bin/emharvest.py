...
class SessionTab(QWidget):
    def __init__(self):
        ...
        self.execute_button = QPushButton("Execute EMharvest")
    ...
    def save_settings(self):
        ...
        default_filename = "emharvest_settings_session.json"
    ...
    def execute_script(self):
        print('Running full EMharvest analysis')
        try:
            ...
            if os.path.exists(script_to_execute):
                command_line_args = '--e ' + str(self.selected_script) + ' --o processing --atlas ' + str(
...
class GlobalTab(QWidget):
    def __init__(self):
        ...
        self.execute_button = QPushButton("Execute EMharvest global analysis")
    ...
    def save_settings(self):
        ...
        options = file_dialog.Options()
        options |= file_dialog.DontUseNativeDialog
        default_filename = "emharvest_settings_global.json"
        file_name, _ = file_dialog.getSaveFileName(self, "Save Settings to File", default_filename, "Settings File (*.json);;All Files (*)", options=options)
